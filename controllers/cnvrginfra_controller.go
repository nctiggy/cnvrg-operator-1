...
func (r *CnvrgInfraReconciler) FixIstioDeploymentError(cnvrgInfra *mlopsv1.CnvrgInfra) error {
	if cnvrgInfra.Spec.Networking.EastWest.Enabled && cnvrgInfra.Spec.Networking.EastWest.Primary == false && cnvrgInfra.Spec.Networking.EastWest.ClusterIpsEnabled {
